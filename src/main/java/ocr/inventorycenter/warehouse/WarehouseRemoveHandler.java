 ...
 */
//业务活动功能处理器
public class WarehouseRemoveHandler  extends SampleSingleDocBaseHandler {
	

	public WarehouseRemoveHandler(AppActivityImpl appActivity) {
		super(appActivity);
	...
	public String getEventAddress() {
		...
		return WarehouseConstant.REMOVE_ADDRESS;
	}
