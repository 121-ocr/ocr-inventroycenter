 ...
 */
//业务活动功能处理器
public class WarehouseUpdateHandler  extends SampleSingleDocBaseHandler {
	
	public WarehouseUpdateHandler(AppActivityImpl appActivity) {
		super(appActivity);
	}
	...
	public String getEventAddress() {
		return WarehouseConstant.UPDATE_ADDRESS;
	}
