 ...
 */
//业务活动功能处理器
public class InventorycheckRemoveHandler  extends SampleSingleDocBaseHandler {
	...
	public ActionDescriptor getActionDesc() {
		...
		// 状态变化定义
		BizStateSwitchDesc bizStateSwitchDesc = new BizStateSwitchDesc(BizRootType.BIZ_OBJECT, null, InventorycheckConstant.REMOVE_STATUS);
