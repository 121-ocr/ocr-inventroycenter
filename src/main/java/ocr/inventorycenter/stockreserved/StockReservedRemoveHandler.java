 ...
 *
 */
public class StockReservedRemoveHandler extends SampleBillBaseHandler {

	public static final String ADDRESS = StockReservedConstant.RemoveAddressConstant;

	public StockReservedRemoveHandler(AppActivityImpl appActivity) {
		super(appActivity);
