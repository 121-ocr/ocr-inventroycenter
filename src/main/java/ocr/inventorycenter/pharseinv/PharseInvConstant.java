 ...
 *
 */
public class PharseInvConstant {

	
	// -----------------组件信息
	public static String ComponentNameConstant = "pharseinv-mgr";
	public static String ComponentBizObjectTypeConstant = "bp_pharseinv";
