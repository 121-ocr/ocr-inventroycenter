 ...
 */
// 业务活动功能处理器
public class PharseInvBatchCreateHandler extends ActionHandlerImpl<JsonArray> {
	
	public static final String ADDRESS = "batch_create";

	public PharseInvBatchCreateHandler(AppActivityImpl appActivity) {
		super(appActivity);
	...
	private void recordReplicationData(JsonObject actor, int i, int size, JsonArray datas, 
		...
		JsonObject pharseInvOjb = datas.getJsonObject(i);
		
    	String boId = pharseInvOjb.getString("bo_id");
