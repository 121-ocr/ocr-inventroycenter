...
public class AllocateordersCreateHandler  extends SampleSingleDocBaseHandler {
	...
	public String getEventAddress() {
		return AllocateordersConstant.CREATE_ADDRESS;
	}
	...
	public ActionDescriptor getActionDesc() {
		...
		// 状态变化定义
		BizStateSwitchDesc bizStateSwitchDesc = new BizStateSwitchDesc(BizRootType.BIZ_OBJECT, null, AllocateordersConstant.CREATE_STATUS);
