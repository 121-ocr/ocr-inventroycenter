...
public class GetAllocateordersNameHandler extends SampleSingleDocQueryHandler {
	...
	public GetAllocateordersNameHandler(AppActivityImpl appActivity) {
		super(appActivity);
	...
	public void handle(OtoCloudBusMessage<JsonObject> msg) {
		...
		JsonObject queryObj ;
		if(query.getJsonObject("allocateorders") != null){
			JsonObject obj = query.getJsonObject("allocateorders");
			String jsonStr = "{\"allocateorders._id\":\""+obj.getString("_id")+"\"}";
