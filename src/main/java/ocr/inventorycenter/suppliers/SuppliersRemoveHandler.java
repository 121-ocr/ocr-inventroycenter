 ...
 */
//业务活动功能处理器
public class SuppliersRemoveHandler  extends SampleSingleDocBaseHandler {
	

	public SuppliersRemoveHandler(AppActivityImpl appActivity) {
		super(appActivity);
	...
	public String getEventAddress() {
		...
		return SuppliersConstant.REMOVE_ADDRESS;
	}
	...
	public ActionDescriptor getActionDesc() {
		...
		// 状态变化定义
		BizStateSwitchDesc bizStateSwitchDesc = new BizStateSwitchDesc(BizRootType.BIZ_OBJECT, null, SuppliersConstant.REMOVE_STATUS);
