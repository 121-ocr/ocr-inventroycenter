 ...
 *
 */
public class StockOutCreateHandler extends SampleBillBaseHandler {

	public static final String ADDRESS = StockOutConstant.CreateAddressConstant;

	public StockOutCreateHandler(AppActivityImpl appActivity) {
		super(appActivity);
